...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(Amada,subset = '2018-07::2018-09',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. For most weeks in this period, the CAR has fallen (week-on-week)
chartSeries(to.weekly(Amada.CAR),subset = '2018-06::2018-09',up.col='white',dn.col='blue')

chartSeries(Amada.CAR, 
            type = c("auto", "candlesticks"), 
            subset = '2018-07::2018-09',
            show.grid = TRUE,
...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(Hokuetsu,subset = '2018-07::2018-09',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. 
chartSeries(to.weekly(Hokuetsu.CAR),subset = '2018-06::2018-09',up.col='white',dn.col='blue')

chartSeries(Hokuetsu.CAR, 
            type = c("auto", "candlesticks"), 
            subset = '2018-07::2018-09',
            show.grid = TRUE,
            major.ticks='auto', minor.ticks=TRUE,
...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(Mitsubishi,subset = '2018-07::2018-09',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. 
chartSeries(to.weekly(Mitsubishi.CAR),subset = '2018-06::2018-09',up.col='white',dn.col='blue')

chartSeries(Mitsubishi.CAR, 
            type = c("auto", "candlesticks"), 
            subset = '2018-07::2018-09',
            show.grid = TRUE,
            major.ticks='auto', minor.ticks=TRUE,
...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(Secom,subset = '2018-07::2018-09',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. 
chartSeries(to.weekly(Secom.CAR),subset = '2018-06::2018-09',up.col='white',dn.col='blue')

chartSeries(Secom.CAR, 
            type = c("auto", "candlesticks"), 
            subset = '2018-07::2018-09',
            show.grid = TRUE,
            major.ticks='auto', minor.ticks=TRUE,
...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(Tokyu,subset = '2018-07::2018-09',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. 
chartSeries(to.weekly(Tokyu.CAR),subset = '2018-06::2018-09',up.col='white',dn.col='blue')

chartSeries(Tokyu.CAR, 
            type = c("auto", "candlesticks"), 
            subset = '2018-07::2018-09',
            show.grid = TRUE,
            major.ticks='auto', minor.ticks=TRUE,
...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(Tata,subset = '2018-08::2018-10',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. 
chartSeries(to.weekly(Tata.CAR),subset = '2018-08::2018-10',up.col='white',dn.col='blue')

chartSeries(Tata.CAR, 
            type = c("auto", "candlesticks"), 
            subset = '2018-08::2018-10',
            show.grid = TRUE,
            major.ticks='auto', minor.ticks=TRUE,
            TA=c(addMACD(),addVo()))
...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(Mahindra,subset = '2018-08::2018-10',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. 
chartSeries(to.weekly(Mahindra.CAR),subset = '2018-08::2018-10',up.col='white',dn.col='blue')

chartSeries(Mahindra.CAR, 
            type = c("auto", "candlesticks"), 
            subset = '2018-08::2018-10',
            show.grid = TRUE,
            major.ticks='auto', minor.ticks=TRUE,
...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(Bajaj,subset = '2018-08::2018-10',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. 
chartSeries(to.weekly(Bajaj.CAR),subset = '2018-08::2018-10',up.col='white',dn.col='blue')

chartSeries(Bajaj.CAR, 
            type = c("auto", "candlesticks"), 
            subset = '2018-08::2018-10',
            show.grid = TRUE,
            major.ticks='auto', minor.ticks=TRUE,
...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(ICICI,subset = '2018-08::2018-10',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. 
chartSeries(to.weekly(ICICI.CAR),subset = '2018-08::2018-10',up.col='white',dn.col='blue')

chartSeries(ICICI.CAR, 
            type = c("auto", "candlesticks"), 
            subset = '2018-08::2018-10',
            show.grid = TRUE,
            major.ticks='auto', minor.ticks=TRUE,
...
#Observing the trends in the stock price and stock volume sold (MAYBE DELETE THIS LINE OF CODE!!)
chartSeries(LT,subset = '2018-08::2018-10',up.col='white',dn.col='blue')

#Aggregating daily data to weekly data to get a more concise idea of CAR effects across the EW. 
chartSeries(to.weekly(LT.CAR),subset = '2018-08::2018-10',up.col='white',dn.col='blue')

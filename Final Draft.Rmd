...
Estimation Period: From 9th May to 29th June
Event Window: From 2nd July to 7th September
...
r1<- glm(Hokuetsu.EP$Hokuetsu.SRP~ Hokuetsu.EP$Hokuetsu.MRP) 
summary(r1)
...
#Calculate the Abnormal Revenue in the Event Window 
Hokuetsu.EW$Hokuetsu.AR <- Hokuetsu.EW$Hokuetsu.Return - (JPRF.EW$Return - alpha + beta*(JPMKT.EW$Return - JPRF.EW$Return))
...
r1<- glm(Mitsubishi.EP$Mitsubishi.SRP~ Mitsubishi.EP$Mitsubishi.MRP) 
summary(r1)
...
#Calculate the Abnormal Revenue in the Event Window 
Mitsubishi.EW$Mitsubishi.AR <- Mitsubishi.EW$Mitsubishi.Return - (JPRF.EW$Return - alpha + beta*(JPMKT.EW$Return - JPRF.EW$Return))
...
r1<- glm(Secom.EP$Secom.SRP~ Secom.EP$Secom.MRP) 
summary(r1)
...
#Calculate the Abnormal Revenue in the Event Window 
Secom.EW$Secom.AR <- Secom.EW$Secom.Return - (JPRF.EW$Return - alpha + beta*(JPMKT.EW$Return - JPRF.EW$Return))
...
r1<- glm(Tokyu.EP$Tokyu.SRP~ Tokyu.EP$Tokyu.MRP) 
summary(r1)
...
#Calculate the Abnormal Revenue in the Event Window 
Tokyu.EW$Tokyu.AR <- Tokyu.EW$Tokyu.Return - (JPRF.EW$Return - alpha + beta*(JPMKT.EW$Return - JPRF.EW$Return))
...
Tata.EW<- Tata[39:88,] #Creating a subset for our Event Window

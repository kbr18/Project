...
```{r eval=FALSE, include=TRUE}
results <- phys2eventtime(z=StockPriceReturnJP$Index.Date.Amada.Hokuetsu.Mitsubishi.Secom.Tokyu, events=eventDateJP[i, any(class(StockPriceReturnJP) %in% "zoo")], width = 10)
